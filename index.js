...
const uri = "mongodb+srv://ivkvkishore:kishoreveli.2024@cluster0.q2ejg0i.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
async function run() {
  try {
    ...
    const productfood=client.db("food_collections").collection("foods");
